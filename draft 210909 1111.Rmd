...
The p-value for every variable (except TEAM_BATTING_HBP, which will be dropped) is near zero. Therefore none of the variables can be considered normally distributed. 
###
...
JW: Looking at `TEAM_BATTING_SO`, althought the groupings are not correlated to wins, it does seem that there are bands of strikeout counts at zero and at 100 SO. 
###
